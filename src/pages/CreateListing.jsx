    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <input
          ...
          vale={name}
          onChange={onchange}
          placeholder="Enter Name with >10 characters"
          maxLength="32"
          minLength="10"
          required
        ...
        <div className="flex space-x-6 mb-6">
          <div>
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-700 bg-blue-100 border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center"
            />
          </div>
          <div>
        ...
        <div className="flex">
          <button
            ...
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${
              !parking ? "bg-green-400 text:black" : "bg-red-400 text-white"
            }`}
          >
            Yes
          </button>
        ...
        <div className="flex">
          <button
            ...
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${
              !furnished ? "bg-green-400 text:black" : "bg-red-400 text-white"
            }`}
          >
            Yes
          </button>
        ...
        <div className="flex mb-6">
          <button
            ...
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${
              !offer ? "bg-green-400 text:black" : "bg-red-400 text-white"
            }`}
          >
            Yes
          </button>
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input
                ...
                max="400000000"
                required
                className="w-full px-4 py-2 text-xl text-gray-700 bg-blue-100 border-gray-300 rounded transition ease-in-out duration-150 focus:text-red-600 focus:bg-white focus:border-slate-600 text-center"
              />
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out duration-150 focus:bg-white focus:border-slate-600"
          />
        </div>
        <button
          type="submit"
