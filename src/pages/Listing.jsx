...
export default function Listing() {
  ...
  return (
    <main>
      ...
      <div
        className="fixed top-[13%] right-[3%] z-10 bg-white cursor-pointer border-2 border-gray-400 w-12 h-12 flex justify-center items-center"
        onClick={() => {
      ...
      {shareLinkCopied && (
        <p className="fixed top-[23%] right-[5%] font-semibold border-gray-500 rounded-md bg-white z-10 p-2">
          Link Copied
        </p>
      )}
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className=" w-full">
          ...
          <ul className="flex items-center space-x-2 text-sm font-semibold sm:space-x-10 mb-6">
            ...
            <li className="flex items-center whitespace-nowrap">
              <MdOutlineBathtub className="text-lg mr-1" />
